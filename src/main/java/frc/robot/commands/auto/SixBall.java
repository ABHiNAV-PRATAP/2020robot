...
public class SixBall extends SequentialCommandGroup {
  ...
  public SixBall(Drivetrain drivetrain, Intake intake, Shooter shooter, VisionLEDs leds) {
    ...
    super();
    addCommands(new DriveDistanceStraight(drivetrain, intake, 90), 
    new PIDRotateAngle(drivetrain, shooter, leds), new VisionAssistedShoot(shooter, 3000), 
    new TurnToAngle(drivetrain, 0), 
    new DriveDistanceStraight(drivetrain, intake, 80).withTimeout(4), 
    new DriveDistanceStraight(drivetrain, intake, -80), 
    new PIDRotateAngle(drivetrain, shooter, leds), 
    new VisionAssistedShoot(shooter, 3000), 
    new TurnToAngle(drivetrain, 0), 
